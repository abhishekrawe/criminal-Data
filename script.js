...
$(document).ready(function () {
  ...
  d3.json("https://d3js.org/world-50m.v1.json", function (error, data) {
    ...
    d3.json(
      "https://data.gov.in/node/89971/datastore/export/json?token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJodHRwczpcL1wvZGF0YS5nb3YuaW5cLyIsImF1ZCI6Imh0dHBzOlwvXC9kYXRhLmdvdi5pblwvIiwiaWF0IjoxNjI0MDIwMzk5LCJuYmYiOjE2MjQwMjAzOTksImV4cCI6MTYyNDAyMDQyOSwiZGF0YSI6eyJuaWQiOiI4OTk3MSJ9fQ.hPU59XLlSyKRFIUJuOSQmthvcCZ5asrbnbJq0siulF4",
      function (error, data) {
        if (error) console.error(error);

        var locations = data.fields;
